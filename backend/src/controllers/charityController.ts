...
export const getFeaturedCharity = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const donateToCharity = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
