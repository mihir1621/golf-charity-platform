...
export const uploadWinnerProof = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
...
export const verifyWinnerProof = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const uid = req.user?.uid;
