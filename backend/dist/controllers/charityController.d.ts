...
export declare const getFeaturedCharity: (req: Request, res: Response) => Promise<void>;
export declare const donateToCharity: (req: AuthRequest, res: Response) => Promise<void>;
